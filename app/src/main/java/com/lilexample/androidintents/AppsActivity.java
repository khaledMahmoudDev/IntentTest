...
public class AppsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (btnClick == R.id.btnSetAlarm) {
            ...
            Intent i = new Intent(AlarmClock.ACTION_SET_ALARM).putExtra(AlarmClock.EXTRA_MESSAGE,message).putExtra(AlarmClock.EXTRA_HOUR,hour)
                    .putExtra(AlarmClock.EXTRA_MINUTES,minutes).putExtra(AlarmClock.EXTRA_VIBRATE,true);
...
//            String location = "geo:47.6205,-122.3493?q=restaurants";
            ...
            Uri ph = Uri.parse("tel:"+phoneNumber);
